////////////////////////////////////////////////////////////
// File: JagaimoMenuManager
// Author: James Bradbury
// Edited: Thedoor Danciu
...
public class JagaimoMenuManager : MonoBehaviour
{
    ...
    private int selectedMenuObject;
...

    {
        ...
        else
        {
            for (int i = 0; i < MenuObjects.Length; i++)
            {
                MenuObjects[i].SetActive(i == SelectedMenu);
            }
        }
