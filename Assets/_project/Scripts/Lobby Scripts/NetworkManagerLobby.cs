...
//    [Scene] [SerialzeField] private string menuScene = string.Empty;
//    [Header("Room")]
...
//        {// disconnects player when there are too many players
//            conn.Disconnect();
//            return;
//        }
//
//        if (SceneManager.GetActiveScene().name != menuScene)
//        {// stops people joining while game is in progress
//            conn.Disconnect();
//            return;
//        }
//    }
